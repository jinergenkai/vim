let mapleader=" "
"inoremap <leader>c <ESC>gg<C-v>G
...
nnoremap <C-w>s :call <SID>split('h')<CR>
xnoremap <C-w>s :call <SID>split('h')<CR>

nnoremap <C-w>v :call <SID>split('v')<CR>
xnoremap <C-w>v :call <SID>split('v')<CR>

nnoremap <C-w>n :call <SID>splitNew('h', '__vscode_new__')<CR>
xnoremap <C-w>n :call <SID>splitNew('h', '__vscode_new__')<CR>
...
nnoremap <sileht> <C-k> :call VSCodeNotify('workbench.action.navigateUp')<CR>
